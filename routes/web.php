...
Route::middleware(['auth','verified','role:Admin'])
    ...
    ->group(function () {
        ...
        Route::prefix('submissoes')->as('submissions.')->group(function () {
            ...
            Route::delete('/{submission:slug}/comments/{comment}', [AdminSubmission::class,'commentsDestroy'])->whereNumber('comment')->name('comments.destroy');
        });
       ...
       Route::resource('edicoes', EditionController::class)
        ...
        Route::get('/{submission:slug}/ler', [AdminSubmission::class, 'show'])->name('read');
...
Route::middleware(['auth','verified','role:Coordenador|Admin'])
    ...
    ->group(function () {
        ...
        Route::get('relatorios/revisores', [RelatorioRevisoresController::class, 'index'])->name('relatorios.revisores.index');
        Route::get('relatorios/revisores/{reviewer}', [RelatorioRevisoresController::class, 'show'])->name('relatorios.revisores.show');
...
Route::middleware(['auth','verified'])->scopeBindings()->group(function () {
    ...
    Route::patch ('/submissions/{submission:slug}/comments/{comment}/apply',           [CommentCtrl::class,'applySuggestion'])->whereNumber('comment')->name('comments.apply');
    ...
    Route::delete('/submissions/{submission:slug}/comments/{comment}',                 [CommentCtrl::class, 'destroy'])->whereNumber('comment')->name('comments.destroy');
});
...
Route::middleware(['auth','verified'])
    ...
    ->group(function () {
        ...
        Route::middleware('can:update,submission')->group(function () {
            Route::put('/submissoes/{submission:slug}/section/{section}', [AutorSubmission::class, 'updateSection'])->name('submissions.section.update');
            ...
            Route::post('/submissoes/{submission:slug}/metadata', [AutorSubmission::class, 'updateMetadata'])->name('submissions.metadata.update');
            Route::post('/submissoes/{submission:slug}/configs', [AutorSubmission::class, 'updateConfigs'])->name('submissions.configs.update');

            Route::post('/submissoes/{submission:slug}/assets', [AutorSubmission::class, 'assetsStore'])->name('submissions.assets.store');
            Route::post('/submissoes/{submission:slug}/assets/upload', [AutorSubmission::class, 'uploadAsset'])->name('submissions.assets.upload');
            Route::delete('/submissoes/{submission:slug}/assets/{asset}', [AutorSubmission::class, 'destroyAsset'])->name('submissions.assets.destroy');

            Route::post('/submissoes/{submission:slug}/refs', [AutorSubmission::class, 'storeReference'])->name('submissions.refs.store');
            Route::delete('/submissoes/{submission:slug}/refs/{reference}', [AutorSubmission::class, 'destroyReference'])->name('submissions.refs.destroy');

            Route::post('/submissoes/{submission:slug}/submit', [AutorSubmission::class, 'submit'])->name('submissions.submit');
            Route::delete('/submissoes/{submission:slug}', [AutorSubmission::class, 'destroy'])->name('submissions.destroy');

            Route::patch('/submissoes/{submission:slug}/update-after-submit', [AutorSubmission::class, 'updateAfterSubmit'])->name('submissions.updateAfterSubmit');
        });
